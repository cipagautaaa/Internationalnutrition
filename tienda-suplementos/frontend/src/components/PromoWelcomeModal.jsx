  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center px-4 sm:px-6">
      ...
      <div className="relative max-w-3xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden grid md:grid-cols-2 md:h-[520px]">
        ...
        <div className="bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white p-8 sm:p-10 flex flex-col justify-between gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <button
                onClick={onClaim}
                className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-white text-black font-semibold px-5 py-3.5 shadow-lg shadow-red-600/20 hover:scale-[1.01] hover:-translate-y-0.5 transition"
              >
                Dame mi descuento
