...
/**
 * Botón flotante "Recibe un regalo" que aparece en la esquina inferior izquierda
 * Se muestra siempre (con o sin sesión iniciada)
 */
  ...
  return (
    <button
      ...
      className={`
        ...
        hover:scale-105 hover:shadow-xl hover:shadow-green-600/40
        animate-bounce-slow
      `}
      style={{
      ...
      aria-label="Recibe un regalo por tus compras"
    >
      ...
      <span className="uppercase tracking-wide">Recibe un regalo</span>
